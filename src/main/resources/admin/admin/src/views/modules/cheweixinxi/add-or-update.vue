          ...
          <el-form-item class="input" label="车位编号" prop="cheweibianhao">
              <el-input v-model="ruleForm.cheweibianhao" 
                placeholder="车位编号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="车位名称" prop="cheweimingcheng">
          <el-input v-model="ruleForm.cheweimingcheng" 
              placeholder="车位名称" clearable  :readonly="ro.cheweimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="车位名称" prop="cheweimingcheng">
              <el-input v-model="ruleForm.cheweimingcheng" 
                placeholder="车位名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                ...
                                                                                                this.zhuangtaiOptions = "可停,已停".split(',')
                                              },
                                                // 多级联动参数
                                                              info(id) {
      this.$http({
