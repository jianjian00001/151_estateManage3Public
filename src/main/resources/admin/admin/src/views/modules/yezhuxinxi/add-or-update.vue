  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="门牌号" prop="menpaihao">
              <el-input v-model="ruleForm.menpaihao" 
                placeholder="门牌号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="楼房名称" prop="loufangmingcheng">
          <el-select  @change="loufangmingchengChange" v-model="ruleForm.loufangmingcheng" placeholder="请选择楼房名称">
            <el-option
                v-for="(item,index) in loufangmingchengOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.loufangmingcheng" label="楼房名称" prop="loufangmingcheng">
              <el-input v-model="ruleForm.loufangmingcheng" 
                placeholder="楼房名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="楼房位置" prop="loufangweizhi">
          <el-input v-model="ruleForm.loufangweizhi" 
              placeholder="楼房位置" clearable  :readonly="ro.loufangweizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="楼房位置" prop="loufangweizhi">
              <el-input v-model="ruleForm.loufangweizhi" 
                placeholder="楼房位置" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.loufangmingcheng = true;
            continue;
	            	            ...
	            	            if(o=='loufangweizhi'){
            this.ruleForm.loufangweizhi = obj[o];
	    this.ro.loufangweizhi = true;
            continue;
          }
	            	            	                    }
                                                                                                                                                              }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                ...
                                                                                                this.leixingOptions = "业主,租户".split(',')
                                                          this.$http({
              url: `option/loufangxinxi/loufangmingcheng`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.loufangmingchengOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
                                                    ...
                                                    // 下二随
    loufangmingchengChange () {
      this.$http({
        url: `follow/loufangxinxi/loufangmingcheng?columnValue=`+ this.ruleForm.loufangmingcheng,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
                                                                                                                                                                        if(data.data.loufangweizhi){
                this.ruleForm.loufangweizhi = data.data.loufangweizhi
              }
                                                                          } else {
          this.$message.error(data.msg);
        }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yezhuxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yezhuxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
