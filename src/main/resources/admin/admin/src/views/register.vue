  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(31, 147, 255, 0.83);fontSize:28px;">小区物业管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="个人账号" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.gerenzhanghao" autocomplete="off" placeholder="个人账号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='yonghu'" class="input-group">
			...
			<el-form-item label="身份证号码" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.shenfenzhenghaoma" autocomplete="off" placeholder="身份证号码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='yonghu'" class="input-group">
			...
			<el-form-item label="手机号码" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.shoujihaoma" autocomplete="off" placeholder="手机号码" type="text" />
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.chepaihao" class="input" type="text" placeholder="车牌号">
			   </div>
			 </div> -->
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='yuangong'">
			  <el-input v-model="ruleForm.nianling" autocomplete="off" placeholder="年龄" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='yuangong'" class="input-group">
			   <div class="label">身份证号码</div>
			...
			<el-form-item label="身份证号码" class="input" v-if="tableName=='yuangong'">
			  <el-input v-model="ruleForm.shenfenzhenghaoma" autocomplete="off" placeholder="身份证号码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='yuangong'" class="input-group">
			   <div class="label">手机号码</div>
			...
			<el-form-item label="手机号码" class="input" v-if="tableName=='yuangong'">
			  <el-input v-model="ruleForm.shoujihaoma" autocomplete="off" placeholder="手机号码" type="text" />
			</el-form-item>
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                                                ...
                                                                                                if(`yuangong` == this.tableName && this.ruleForm.shenfenzhenghaoma&&(!this.$validate.checkIdCard(this.ruleForm.shenfenzhenghaoma))){
        this.$message.error(`身份证号码应输入身份证格式`);
        return
      }
                                                      if(`yuangong` == this.tableName && this.ruleForm.shoujihaoma&&(!this.$validate.isMobile(this.ruleForm.shoujihaoma))){
        this.$message.error(`手机号码应输入手机格式`);
        return
      }
                                                                                                                                                                                                                                                                        this.$http({
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20201125/83f04089c4b74aa4a89ab0f7597185f5.jpg");
		height: 100vh;
		...
		.login-form {
			...
			.rgs-form {
				...
				.btn {
					...
					border-width: 1px;
					border-style: solid;
					border-color: rgba(232, 195, 62, 0.74);
					border-radius: 4px;
